...
#uv run python cs336_systems/benchmark_basic.py --model_type $model_type --mode $mode --context_length $context_length > benchmark_${model_type}_${context_length}_${mode}_${current_time}.log 2>&1

# 2.测试mode=forward所有model size, context length
model_type=all
mode=forward
#uv run python cs336_systems/benchmark_basic.py --all --mode $mode > benchmark_${model_type}_all_${mode}_${current_time}.log 2>&1
...
context_length=all
uv run python cs336_systems/benchmark_basic.py --model_type $model_type --mode $mode > benchmark_${model_type}_${context_length}_${mode}_${current_time}.log 2>&1
